...
@section('container')
    ...
    <div class="row">
        <div class="col-sm-3 stretch-card grid-margin">
            ...
            <div class="card">
                <a href="{{ route('superadmin.admin.account') }}">
                    <div class="card-body px-3 text-dark">
                        <div class="d-flex justify-content-between">
                            <p class="hovertext text-muted font-20 mb-0"data-hover="Jumlah admin saat ini">
                                Admin</p>
                        </div>
                        <h5 class="font-weight-semibold text-center font-20 mt-3">{{ $totalAdmin }}</h5>
                    </div>
                </a>
            </div>
        </div>
            ...
            <div class="card">
                <div class="card-body px-3 text-dark">
                    ...
                    <div class="d-flex mr-5 mt-2">
                        ...
                        <button type="button" class="btn btn-social-icon btn-outline-sales ml-2">
